...
import image2 from '../../assets/9.jpeg';
...
export default function Services(){
    return  <body className="services_body">
            ...
            <section className="services_content">
                <p className="initial_text">Dubai-Landscapes is one of the most experienced and reliable garden landscaping companies in the UAE. 
                ...
                <p className="third_text">Our team can transform every garden or outdoor space, taking on board the unique requirements of our customers.
                ...
                <p className="fourth_text">A British-owned company, whose entire team is English managed, we always use products that have been manufactured using the highest quality materials. 
